...
public class MasterPanel {
    ...
    private static JScrollPane genCenter() {
        ...
        SpringUtilities.makeCompactGrid(center, Instruction.MEMORY_CELLS+1,
                                        2 , 5, 5, 15, 15);
    ...
    public void reset() {
        instance.cpu= new CPU();
        instance.syncCPU();
        for (JLabel e : ram.getCells())  e.setText( Instruction.toBitString(16,0) );
    }
    ...
    private void clearCode() {
        ...
        for(int i = 0; i < code.size(); i++) code.get(i).set(is);
    }
    ...
    private void textLoad(FileInputStream fis) {
        ...
        while( (cmd = br.readLine()) != null ) {
            if(Instruction.isComment(cmd)) continue;
