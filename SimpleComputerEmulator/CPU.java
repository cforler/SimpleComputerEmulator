...
public class CPU {
  ...
  public void setPC(int value) {
    if (value < Instruction.MEMORY_CELLS)
      pc = value;
  }
  ...
  public void setIR(Instruction value) { ir = value; }
  ...
  public void execute() {
    ...
    case LOAD:
      if (ir.getNumber())
        ...
        acc = Integer.parseInt(r.getCell(operand).getText());
      return;

    case STORE:
      if (!ir.getNumber())
        r.getCell(operand).setText(Integer.toString(acc));
      return;
    ...
    case EQUAL:
      ...
      if (ir.getNumber())
        ...
        x = Integer.parseInt(r.getCell(operand).getText());
      if (acc == x)
        pc += 1;
      return;
    ...
    case JUMP:
      if (ir.getNumber())
        ...
        pc = Integer.parseInt(r.getCell(operand).getText());
      return;
